...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        }if($rolillo == 2){ //usuario
            header("Location: ../Perfil.php?usuario=$usuario2");

        }if($rolillo == 3){//vendedor
            //header("Location: ../Php/Usuario_Privado/Perfil_usuario_privado.php?usuario=$usuario");
            header("Location: ../Inventario.php?usuario=$usuario2");
        }
