...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "CALL lista_InsertarVentaYProductos($tarjeta_usuario_ID, '$tarjeta_nombre', '$tarjeta_num', '$tarjeta_fecha_vencimiento', '$tarjeta_csv', $tarjeta_credito_debito, $tarjeta_estatus, $usua_ID_comp, $cali_valor, $vent_estatus, $subtotal,$lista
    )";
