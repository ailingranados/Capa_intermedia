...
<body class="degradado" style="width: 100%; height: 100%;">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
         <a class="nav-link" href="Perfil_vendedor.php?usuario=<?php echo urlencode($usuario); ?>">Perfil</a>
          </li>
  ...
  <div class="info-bar">
    ...
    <h2>Vendedor: <?php echo isset($usuario) ? $usuario : ''; ?></h2>
    <p style="color: #f2f2f2;">-----</p>
    </ul>
  </div>
<br><br><br>
<div class="data-column">
  ...
  <h1 style="color: palevioletred;">Productos publicados</h1>
</div>
