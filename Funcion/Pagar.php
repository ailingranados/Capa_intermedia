...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $tarjeta_fecha_vencimiento = $tarjeta_mes + $tarjeta_year;
    ...
    $query = "CALL InsertarVentaYProductos($tarjeta_usuario_ID, '$tarjeta_nombre', '$tarjeta_num', '$tarjeta_fecha_vencimiento', '$tarjeta_csv', $tarjeta_credito_debito, $tarjeta_estatus, $usua_ID_comp, $cali_valor, $vent_estatus
    )";
